...
class AuthController extends Controller
{
    ...
    public function logout()
    {
        ...
        return redirect()->route('login')->with('message', 'Berhasil keluar dari portal');
    }
    ...
    public function attemptForgot()
    {
        ...
        return redirect()->route('forgot')->with('message', lang('Auth.forgotEmailSent'));
    }
