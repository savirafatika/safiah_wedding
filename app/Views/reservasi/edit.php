     ...
     <section class="section">
          ...
          <div class="section-body">
               ...
               <div class="row">
                    <div class="col-lg-8">
                         <div class="card">
                              <form class="needs-validation" novalidate="" action="<?= base_url('superadmin/produk/update/' . $produk['id_produk']); ?>" method="post" enctype="multipart/form-data">
                                   <?= csrf_field(); ?>
                                   ...
                                   <div class="card-body">
                                        ...
                                        <input type="hidden" name="oldFotoProduk" value="<?= $produk['foto_produk']; ?>" />
                                        <div class="form-group row">
                                             <label for="nama_produk" class="col-sm-3 col-form-label">Nama Produk</label>
                                             <div class="col-sm-9">
                                                  <input type="text" class="form-control <?php if (session('errors.nama_produk')) : ?>is-invalid<?php endif ?>" name="nama_produk" id="nama_produk" value="<?= $produk['nama_produk']; ?>">
                                        ...
                                        <div class="form-group row">
                                             ...
                                             <div class="col-sm-9">
                                                  <textarea name="deskripsi" id="deskripsi" class="summernote-simple <?php if (session('errors.deskripsi')) : ?>is-invalid<?php endif ?>"><?= $produk['deskripsi']; ?></textarea>
                                        ...
                                        <div class="form-group row">
                                             ...
                                             <div class="col-sm-9">
                                                  <select class="form-control select2 <?php if (session('errors.kategori_id')) : ?>is-invalid<?php endif ?>" name="kategori_id" id="kategori_id">
                                                       <option></option>
                                                       <?php foreach ($kategoriOption as $k) : ?>
                                                            <?php
                                                            $selected = '';
                                                            if (($produk['kategori_id'] == $k['id_kategori']) && ($produk['id_produk'] == $kategori['id_produk'])) {
                                                                 $selected = 'selected';
                                                            }
                                                            ?>
                                        ...
                                        <div class="form-group row">
                                             ...
                                             <div class="col-sm-9">
                                                  ...
                                                  <?php endif ?>
                                                  <br>
                                                  <img id="preview_foto_produk" src="<?= base_url('images/katalog/' . $produk['foto_produk']); ?>" alt="foto_produk image" width="250" />
                                             </div>
                                        </div>
                                   </div>
