          ...
          <div class="section-body">
               <div class="invoice col-lg-9">
                                   ...
                                   <div class="row">
                                        <div class="col-md-6">
                                             <address>
                                                  ...
                                                  $tgl_order = date_format(date_create($reservasi['created_at']), "d M Y H:i:s");
                                                  ?>
                                                  <?= $tgl_order; ?>
                                             </address>
                                        </div>
                    ...
                    <div class="text-md-right">
                         ...
                         <a href="<?= base_url('admin/faktur_cetak/' . $reservasi['id_reservasi']); ?>" class="btn btn-warning btn-icon icon-left" target="blank"><i class="fas fa-print"></i> Cetak Faktur</a>
                    </div>
               </div>
          </div>
     </section>
